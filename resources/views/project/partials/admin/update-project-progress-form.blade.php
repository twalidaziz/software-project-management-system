<section>
    <header>
        <h2 class="text-lg font-medium text-gray-900 dark:text-gray-100">
            {{ __('Project Timeline & Progress') }}
        </h2>

        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
            {{ __("Update project's timeline and progress.") }}
        </p>
    </header>
    ...
    <form method="post" action="{{ route('project.update', $project) }}" class="mt-6 space-y-6">
        ...
        <select id="status" name="status" style="margin-top: 8px" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-64 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            <option selected>{{ $progress->status }}</option>
        ...
        <!-- Progress remarks -->
        <x-input-label style="margin-bottom: 8px" for="status" :value="__('Progress remarks')" />
        <textarea id="remarks" name="remarks" rows="4" style="margin-top: 8px" class="block p-2.5 w-1/2 text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Input remarks here..."></textarea>
